...
// --- Color palettes ---
const lightColors = { background: '#FFFFFF', formBackground: '#FFFFFF', text: '#121212', inputBackground: '#F0F0F0', inputPlaceholder: '#888888', buttonBackground: '#F5D061', buttonText: '#2A363B', link: '#2A363B', toggleInactive: '#E0E0E0', toggleActive: '#FBBF24', };
const darkColors = { background: '#121212', formBackground: '#1E1E1E', text: '#EAEAEA', inputBackground: '#2E2E2E', inputPlaceholder: '#888888', buttonBackground: '#FBBF24', buttonText: '#121212', link: '#EAEAEA', toggleInactive: '#424242', toggleActive: '#FBBF24', }; // keep as in your code
...
const getStyles = (theme: 'light' | 'dark') => {
  ...
  return StyleSheet.create({
    ...
    signupText: { color: colors.text, fontFamily: 'Poppins-Regular', fontSize: 28 },
    ...
    signupButton: { backgroundColor: colors.buttonBackground, borderRadius: 15, paddingVertical: 10, paddingHorizontal: 25 },
    signupButtonText: { color: colors.buttonText, fontSize: 16, fontFamily: 'Poppins-Regular' },
    loginPromptContainer: { alignItems: 'flex-end' },
    alreadyText: { color: colors.text, fontFamily: 'Poppins-Regular', fontSize: 14 },
    loginButton: { fontFamily: 'Poppins-Regular', fontSize: 14, color: '#b53d3e', textDecorationLine: 'underline' },
